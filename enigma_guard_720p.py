...
def pygal_analytics_graph():
    ...
    graph_image = customtkinter.CTkImage(light_image=Image.open(chart_filename),dark_image=Image.open(chart_filename),size = (852,256))
    graph_label = customtkinter.CTkLabel(analytics_frame_win,image=graph_image,text="",width=852,height=256)
    graph_label.place(x=364,y=355)
...
def encrypt_win():
    ...
    encrypt_title_textbox.place(x=10,y=7)
    ...
    def fernet_encryption():
        ...
        encrypt_copy_button.place(x=185,y=13)
...
def keys_win():
    ...
    def create_labels():
        ...
        label_height = 60
        y_offset = 25
        initial_y_for_secondary_label = 28
        initial_y_for_copy_button = 26
        ...
        for row in data:
            ...
            title_label = customtkinter.CTkLabel(keys_label_frame_win, width=940, height=55, bg_color="#000000", fg_color="#000000", image=number_of_keys_img, text="")
            ...
            label.place(x=95, y=initial_y_for_secondary_label)

            label2 = customtkinter.CTkLabel(keys_label_frame_win, text=row[1][0:17]+"...", font=armin_grotesk_ultra_bold, text_color="#FFFFFF", bg_color="#000000", fg_color="#000000")
            label2.place(x=335, y=initial_y_for_secondary_label)
            ...
            button_label_2_copy.place(x=600, y=initial_y_for_copy_button)
            ...
            label3.place(x=720, y=initial_y_for_secondary_label)
            ...
            row_delete_button.place(x=870, y=initial_y_for_copy_button)
...
armin_grotesk_ultra_bold = customtkinter.CTkFont(family="Armin Grotesk UltraBold",size=22,weight="normal")
armin_grotesk_ultra_bold_30 = customtkinter.CTkFont(family="Armin Grotesk UltraBold",size=40,weight="normal")

analytics_tab_deselect_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\analytics_tab_deselect.png"),dark_image=Image.open(".\\_internal\\assets\\analytics_tab_deselect.png"),size=(260,60))
encrypt_tab_deselect_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\encrypt_tab_deselect.png"),dark_image=Image.open(".\\_internal\\assets\\encrypt_tab_deselect.png"),size=(260,60))
decrypt_tab_deselect_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\decrypt_tab_deselect.png"),dark_image=Image.open(".\\_internal\\assets\\decrypt_tab_deselect.png"),size=(260,60))
keys_tab_deselect_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\keys_tab_deselect.png"),dark_image=Image.open(".\\_internal\\assets\\keys_tab_deselect.png"),size=(260,60))
settings_tab_deselect_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\settings_tab_deselect.png"),dark_image=Image.open(".\\_internal\\assets\\settings_tab_deselect.png"),size=(260,60))
analytics_tab_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\analytics_tab.png"),dark_image=Image.open(".\\_internal\\assets\\analytics_tab.png"),size=(260,60))
encrypt_tab_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\encrypt_tab.png"),dark_image=Image.open(".\\_internal\\assets\\encrypt_tab.png"),size=(260,60))
decrypt_tab_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\decrypt_tab.png"),dark_image=Image.open(".\\_internal\\assets\\decrypt_tab.png"),size=(260,60))
keys_tab_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\keys_tab.png"),dark_image=Image.open(".\\_internal\\assets\\keys_tab.png"),size=(260,60))
settings_tab_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\settings_tab.png"),dark_image=Image.open(".\\_internal\\assets\\settings_tab.png"),size=(260,60))
encryption_type_optionmenu_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\encryption_type_optionmenu.png"),dark_image=Image.open(".\\_internal\\assets\\encryption_type_optionmenu.png"),size=(244,62))
decryption_type_optionmenu_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\decryption_type_optionmenu.png"),dark_image=Image.open(".\\_internal\\assets\\decryption_type_optionmenu.png"),size=(244,62))
...
encrypt_frame_win_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\encryption_main.png"), dark_image=Image.open(".\\_internal\\assets\\encryption_main.png"),size=(1280,720))
decrypt_frame_win_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\decryption_main.png"), dark_image=Image.open(".\\_internal\\assets\\decryption_main.png"),size=(1280,720))
analytics_frame_win_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\sec_win.png"), dark_image=Image.open(".\\_internal\\assets\\sec_win.png"),size=(1280,720))
bg_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\bg_image.png"), dark_image=Image.open(".\\_internal\\assets\\bg_image.png"), size=(1280,720))
...
encrypt_button_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\encrypt_button.png"),dark_image=Image.open(".\\_internal\\assets\\encrypt_button.png"),size=(250,58))
decrypt_button_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\decrypt_button.png"),dark_image=Image.open(".\\_internal\\assets\\decrypt_button.png"),size=(250,58))
key_frame_win_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\keys_main.png"), dark_image=Image.open(".\\_internal\\assets\\keys_main.png"), size=(1280,720))
setting_frame_win_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\settings_main.png"), dark_image=Image.open(".\\_internal\\assets\\settings_main.png"), size=(1280,720))
number_of_keys_img = customtkinter.CTkImage(light_image=Image.open(".\\_internal\\assets\\number_of_keys.png"), dark_image=Image.open(".\\_internal\\assets\\number_of_keys.png"),size=(900,55))
...
settings_minimize = customtkinter.CTkImage(light_image=Image.open('.\\_internal\\assets\\settings_minimize.png'),dark_image=Image.open('.\\_internal\\assets\\settings_minimize.png'),size=(910,80))
...
ashhad_github.place(x=1210,y=18)

total_encryptions_decryptions_label = customtkinter.CTkLabel(analytics_frame_win, width=47,height=44,text="00",font=armin_grotesk_ultra_bold_30,bg_color="#000000",fg_color="#000000",text_color="#FFFFFF")
total_encryptions_decryptions_label.place(x=127,y=140)
...
total_app_time.place(x=1080 ,y=152)
...
total_encryptions_analytic_frame_label.place(x=418,y=152)
...
total_decryptions_analytic_frame_label.place(x=651,y=152)
...
analytics_tab.place(x=15,y=281)
...
encrypt_deselect_tab.place(x=15,y=352) 
...
decrypt_deselect_tab.place(x=15,y=423)
...
keys_deselect_tab.place(x=15,y=494)
...
settings_deselect_tab.place(x=15,y=565)
...
total_encryptions_decryptions_label2.place(x=127,y=140)
...
analytics_deselect_tab.place(x=15,y=281)
...
total_encryptions_decryptions_label3.place(x=127,y=140)
...
analytics_tab_deselect.place(x=15,y=281)
...
encrypt_tab_deselect.place(x=15,y=352)
...
total_encryptions_decryptions_label4.place(x=127,y=140)
...
total_encryptions_decryptions_label5.place(x=127,y=140)
...
keys_tab_deselect.place(x=15,y=494)
